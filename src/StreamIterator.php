...
class StreamIterator implements SeekableIterator
{
    ...
    {
        return fputcsv($this->stream, $fields, $this->filterControl($delimiter, 'delimiter', __METHOD__), $this->filterControl($enclosure, 'enclosure', __METHOD__), $this->filterControl($escape, 'escape', __METHOD__));
    }
